...
abstract class LevelScene extends BaseScene implements DevEntityPickerDelegate
{
    ...
    public function __construct(
        ...
        protected string $levelName = 'hl_mp_stalkyard'
    )
    {
        ...
        $objectLoader->loadAllInDirectory(VISU_PATH_RESOURCES . '/models/hl_mp_stalkyard', $objectCollection, 4.0);
    ...
    private function handleConsoleCommandLevelTerrain(ConsoleCommandSignal $signal) : void
    {
        ...
        $signal->console->writeLine(VISU_PATH_RES_TERRAIN . $terrainFile);
